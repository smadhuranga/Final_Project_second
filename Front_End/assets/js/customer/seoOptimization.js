    ...
    url: API_BASE + 'admin/users?type=SELLER', // Changed endpoint to generic sellers
    method: 'GET'
});
...
`));
    ...
    // Update the view-seller button click handler
    // Update the view-seller click handler

    // Replace the existing view-seller click handler with this


    // Rest of the script remains the same as previous version
    // [Keep all other functions from the previous script version]
    // Filter System
    ...
    // Chat System
    // Replace existing chat click handler with this
